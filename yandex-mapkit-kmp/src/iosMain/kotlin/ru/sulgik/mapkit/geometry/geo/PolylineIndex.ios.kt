...
import YandexMapKit.YMKPolylineIndex as NativePolylineIndex
...
public actual class PolylineIndex internal constructor(
    ...
    public actual fun closestPolylinePosition(
        ...
        return nativePolylineIndex
            .closestPolylinePositionWithPoint(point.toNative(), priority.toNative(), maxLocationBias)
            ?.toCommon()
    }
    ...
    public actual fun closestPolylinePosition(
        ...
        return nativePolylineIndex.closestPolylinePositionWithPoint(
            point.toNative(),
