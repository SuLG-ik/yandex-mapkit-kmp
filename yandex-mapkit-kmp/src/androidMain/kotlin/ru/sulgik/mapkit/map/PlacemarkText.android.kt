...
import com.yandex.mapkit.map.PlacemarkText as NativePlacemarkText
...
public actual class PlacemarkText internal constructor(
    ...
    actual override fun equals(other: Any?): Boolean {
        ...
        if (other !is PlacemarkText) return false
        if (this::class != other::class) return false
        return nativePlacemarkText == other.nativePlacemarkText
    }
    ...
    actual override fun hashCode(): Int {
        return nativePlacemarkText.hashCode()
    }
}
