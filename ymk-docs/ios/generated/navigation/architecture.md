...
section: "iOS / NaviKit SDK / Общая архитектура"
source: "https://yandex.ru/maps-api/docs/mapkit/ios/generated/navigation/architecture.html"
---
# Общая архитектура NaviKit SDK

`IOS` · `Swift/Objective-C` · `Guide` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/ios/generated/navigation/architecture.html)
...
![NaviKit SDK entities diagram](https://yandex.ru/maps-api/docs/mapkit/ios/_assets/yandex/navigation/architecture/navigation_entities_diagram.png)
