...
section: "Android / NaviKit SDK / Общая архитектура"
source: "https://yandex.ru/maps-api/docs/mapkit/android/generated/navigation/architecture.html"
---
# Общая архитектура NaviKit SDK

`ANDROID` · `Kotlin/Java` · `Guide` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/android/generated/navigation/architecture.html)
...
![NaviKit SDK entities diagram](https://yandex.ru/maps-api/docs/mapkit/android/_assets/yandex/navigation/architecture/navigation_entities_diagram.png)

Данные сущности можно разделить на две группы: full MapKit SDK и более общая группа NaviKit SDK.

## Сущности MapKit SDK

NaviKit SDK включает в себя весь функционал [full](../getting_started.md#add-library)-версии MapKit SDK. Поэтому на диаграмме сущности **Map** и **Directions** находятся в отдельной группе MapKit SDK full.
