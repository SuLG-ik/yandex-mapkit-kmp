...
section: "iOS / Справочник / Objective-C / Classes / YMKBicycleSummarySession"
source: "https://yandex.ru/maps-api/docs/mapkit/Objective-C/YMKBicycleSummarySession.html"
---
# YMKBicycleSummarySession

`IOS` · `Objective-C` · `Class` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/Objective-C/YMKBicycleSummarySession.html)
