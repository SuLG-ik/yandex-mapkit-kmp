...
section: "iOS / Справочник / Objective-C / Classes / YMKBicycleRouterV2"
source: "https://yandex.ru/maps-api/docs/mapkit/Objective-C/YMKBicycleRouterV2.html"
---
# YMKBicycleRouterV2

`IOS` · `Objective-C` · `Class` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/Objective-C/YMKBicycleRouterV2.html)
