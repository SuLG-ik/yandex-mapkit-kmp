...
platform: "ios"
language: "Swift"
section: "iOS / Справочник / Swift / Classes / YMKPlacemarksStyler"
source: "https://yandex.ru/maps-api/docs/mapkit/Swift/YMKPlacemarksStyler.html"
---
# YMKPlacemarksStyler

`IOS` · `Swift` · `Class` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/Swift/YMKPlacemarksStyler.html)

```swift
class YMKPlacemarksStyler : NSObject
```
