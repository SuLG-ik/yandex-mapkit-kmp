...
platform: "ios"
language: "Swift"
section: "iOS / Справочник / Swift / Protocols / YMKMapLoadedListener"
source: "https://yandex.ru/maps-api/docs/mapkit/Swift/YMKMapLoadedListener.html"
---
# YMKMapLoadedListener

`IOS` · `Swift` · `Protocol` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/Swift/YMKMapLoadedListener.html)

```swift
protocol YMKMapLoadedListener : NSObjectProtocol
```
