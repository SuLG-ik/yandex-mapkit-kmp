...
platform: "ios"
language: "Swift"
section: "iOS / Справочник / Swift / Protocols / YMKLayerLoadedListener"
source: "https://yandex.ru/maps-api/docs/mapkit/Swift/YMKLayerLoadedListener.html"
---
# YMKLayerLoadedListener

`IOS` · `Swift` · `Protocol` — [оригинал](https://yandex.ru/maps-api/docs/mapkit/Swift/YMKLayerLoadedListener.html)

```swift
protocol YMKLayerLoadedListener : NSObjectProtocol
```
